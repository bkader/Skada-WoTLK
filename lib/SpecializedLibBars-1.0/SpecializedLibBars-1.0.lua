...
do
  ...
  local function resetClick(self, button)
    self:GetParent().callbacks:Fire("ResetClicked", self:GetParent(), button)
  end
  local function segmentClick(self, button)
    self:GetParent().callbacks:Fire("SegmentClicked", self:GetParent(), button)
  end
  local function modeClick(self, button)
    self:GetParent().callbacks:Fire("ModeClicked", self:GetParent(), button)
  end
  local function reportClick(self, button)
    self:GetParent().callbacks:Fire("ReportClicked", self:GetParent(), button)
  end
    ...
    list.optbutton:SetAlpha(0.75)
    list.optbutton:SetNormalTexture("Interface\\Addons\\Skada\\textures\\icon-config")
    list.optbutton:SetHighlightTexture("Interface\\Addons\\Skada\\textures\\icon-config", 0.5)
    ...
    list.resetbutton = CreateFrame("Button", nil, list)
    list.resetbutton:SetFrameLevel(10)
    list.resetbutton:ClearAllPoints()
    list.resetbutton:SetHeight(16)
    list.resetbutton:SetWidth(16)
    list.resetbutton:SetScale(0.9)
    list.resetbutton:SetAlpha(0.75)
    list.resetbutton:SetNormalTexture("Interface\\Addons\\Skada\\textures\\icon-reset")
    list.resetbutton:SetHighlightTexture("Interface\\Addons\\Skada\\textures\\icon-reset", 0.5)
    list.resetbutton:SetPoint("RIGHT", list.optbutton, "LEFT", -2, 0)
    list.resetbutton:Show()
    list.resetbutton:RegisterForClicks("LeftButtonUp", "RightButtonUp")
    list.resetbutton:SetScript("OnClick", resetClick)

    list.segmentbutton = CreateFrame("Button", nil, list)
    list.segmentbutton:SetFrameLevel(10)
    list.segmentbutton:ClearAllPoints()
    list.segmentbutton:SetHeight(16)
    list.segmentbutton:SetWidth(16)
    list.segmentbutton:SetScale(0.9)
    list.segmentbutton:SetAlpha(0.75)
    list.segmentbutton:SetNormalTexture("Interface\\Buttons\\UI-GuildButton-PublicNote-Up")
    list.segmentbutton:SetHighlightTexture("Interface\\Buttons\\UI-GuildButton-PublicNote-Up", 0.5)
    list.segmentbutton:SetPoint("RIGHT", list.resetbutton, "LEFT", -2, 0)
    list.segmentbutton:Show()
    list.segmentbutton:RegisterForClicks("LeftButtonUp", "RightButtonUp")
    list.segmentbutton:SetScript("OnClick", segmentClick)

    list.modebutton = CreateFrame("Button", nil, list)
    list.modebutton:SetFrameLevel(10)
    list.modebutton:ClearAllPoints()
    list.modebutton:SetHeight(16)
    list.modebutton:SetWidth(16)
    list.modebutton:SetScale(0.9)
    list.modebutton:SetAlpha(0.75)
    list.modebutton:SetNormalTexture("Interface\\Buttons\\UI-GuildButton-OfficerNote-Up")
    list.modebutton:SetHighlightTexture("Interface\\Buttons\\UI-GuildButton-OfficerNote-Up", 0.5)
    list.modebutton:SetPoint("RIGHT", list.segmentbutton, "LEFT", -2, 0)
    list.modebutton:Show()
    list.modebutton:RegisterForClicks("LeftButtonUp", "RightButtonUp")
    list.modebutton:SetScript("OnClick", modeClick)

    list.reportbutton = CreateFrame("Button", nil, list)
    list.reportbutton:SetFrameLevel(10)
    list.reportbutton:ClearAllPoints()
    list.reportbutton:SetHeight(16)
    list.reportbutton:SetWidth(16)
    list.reportbutton:SetScale(0.9)
    list.reportbutton:SetAlpha(0.75)
    list.reportbutton:SetNormalTexture("Interface\\Buttons\\UI-GuildButton-MOTD-Up")
    list.reportbutton:SetHighlightTexture("Interface\\Buttons\\UI-GuildButton-MOTD-Up", 0.5)
    list.reportbutton:SetPoint("RIGHT", list.modebutton, "LEFT", -2, 0)
    list.reportbutton:Show()
    list.reportbutton:RegisterForClicks("LeftButtonUp", "RightButtonUp")
    list.reportbutton:SetScript("OnClick", reportClick)
...
function barPrototype:SetTexCoord(left, right, top, bottom)
  if self.iconTexture then
