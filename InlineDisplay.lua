...
function mod:Create(window, isnew)
  ...
  menu:SetWidth(12)
  menu:SetHeight(12)
  menu:SetNormalTexture("Interface\\Addons\\Skada\\media\\textures\\icon-config")
  menu:SetHighlightTexture("Interface\\Addons\\Skada\\media\\textures\\icon-config", 1.0)
  menu:SetAlpha(1)
    ...
    options.baroptions={
      ...
      args={
        ...
        color={
          ...
          order=0.2,
          hasAlpha=true,
          get=function() local c=db.title.textcolor; return c.r, c.g, c.b, c.a end,
        ...
        barwidth={
          ...
          order=1.0,
          min=100, max=300, step=1.0,
          get=function() return db.barwidth end,
          set=function(win,key) db.barwidth=key; Skada:ApplySettings() end
        },
        ...
        fixedbarwidth={
          ...
          set=function() db.fixedbarwidth=not db.fixedbarwidth; Skada:ApplySettings() end
        },
        ...
        isusingclasscolors={
          ...
          set=function(win,key) db.isusingclasscolors=key; Skada:ApplySettings() end
        },
        ...
        isonnewline={
          ...
          set=function(win,key) db.isonnewline=key; Skada:ApplySettings() end
        },
    ...
    options.elvuioptions={
      ...
      args={
        isusingelvuiskin={
          ...
          set=function(win,key) db.isusingelvuiskin=key; Skada:ApplySettings() end
        },
        ...
        issolidbackdrop={
          ...
          set=function(win,key) db.issolidbackdrop=key; Skada:ApplySettings() end
        }
      }
    }
