...
--[[ Translations improved by: 贾斯丁@Over Power on Icecrown Warmane 2022/12/02 ]] --
...
L["This is your current profile in text format."] = "这是您当前的文本格式的配置文件。"
...
L["Verbose Mode"] = "啰嗦模式"
L["Enable verbose mode for %s."] = "为 %s 启用啰嗦模式。"
L["More Details"] = "更多细节"
L["Active Time"] = "活跃时间"
L["Segment Time"] = "分段时间"
...
L["REFLECT"] = "反射"
L["RESIST"] = "抵制"
L["Only for bosses."] = "只针对首领。"
L["Enable this only against bosses."] = "只对首领启用。"
-- windows section:
L["Window"] = "窗口"
L["Windows"] = "窗口"
...
L["Always save boss fights"] = "总保留首领战"
...
L["Save Theme"] = "保存主题"
L["Delete Theme"] = "删除主题"
L["Are you sure you want to delete this theme?"] = "确定要删除此主题吗？"
-- scroll options
L["Scroll"] = "滚动"
L["Wheel Speed"] = "轮速"
...
L["\124cffffbb00Boss First Target\124r: %s"] = "\124cffffbb00首领第一个目标\124r：%s"
...
L["Conservative Mode"] = "保守模式"
L["Aggressive Mode"] = "激进模式"
L["opt_tweaks_combatlogfixalt_desc"] = "不断清除战斗日志，而不是仅在它损坏时才清除。"
L["%d filtered / %d events found. Cleared combat log, as it broke."] = "过滤了 %d / %d 个事件。 清除战斗日志，因为其已损坏。"
...
L["%s stacks of %s applied on %s in %s sec!"] = "%4$s 秒内将 %1$s 层 %2$s 施放在 %3$s 上！"
L["My Spells"] = "我的技能"
-- total data options
L["Total Segment"] = "总区段" -- needs review
L["All Segments"] = "所有区段" -- needs review
L["Raid Bosses"] = "团队副本首领" -- needs review
L["Raid Trash"] = "团队副本杂兵" -- needs review
L["Dungeon Bosses"] = "小副本首领" -- needs review
L["Dungeon Trash"] = "小副本杂兵" -- needs review
...
L["project_ascension_desc"] = "在 \124cffffbb00Project Ascension\124r 中，您的角色是拥有任何能力或天赋的英雄。\n\n图标和颜色被发送给组成员使用，而不是默认的图标和颜色。"
L["Icon"] = "图标"
L["Color for %s."] = "%s 的颜色。"
L["Choose the %s that fits your character's build."] = "选择适合您的角色的%s。"
