...
L["Child window"] = "子窗口"
L["A child window will replicate the parent window actions."] = "子窗口将复制父窗口的操作。"
L["Lock window"] = "锁定窗口"
...
L["Encounter timer"] = "交叠计时器"
L["When enabled, a stopwatch is shown on the left side of the text."] = "启用时，始终在文本左侧显示秒表计数器。"
L["Title height"] = "标题高度"
...
L["Smart stop"] = "智能停止"
L["Automatically stops the current segment after the boss has died.\nUseful to avoid collecting data in case of a combat bug."] = "老板死亡后自动停止当前句段。\n避免在发生战斗错误时收集数据很有用。"
...
L["HPS"] = "HPS"
L["Healing: Personal HPS"] = "伤害：个人HPS"
L["RHPS"] = "RHPS"
L["Healing: Raid HPS"] = "伤害：团队HPS"
