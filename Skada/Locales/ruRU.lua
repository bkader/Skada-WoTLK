...
L["Boss fights will be kept with this on and will not be affected by Skada reset."] = "При включении этой опции будут бои с боссами будут сохранены, и не будут затронуты сбросом Skada."
...
L["Healing received"] = "Исцеление: Получено"
...
L["Enemy damage done"] = "Получено урона: От противников"
...
L["Enemy damage taken"] = "Урон: Получено врагом"
...
L["Damage mitigated"] = "Получено урона: Уменьшение урона"
L["%s's mitigated damage"] = "%s - Уменьшение урона"
L["%s's <%s> mitigated damage"] = "%s - Уменьшение урона <%s>"
