...
L["tentativetimer_desc"] = "Количество секунд, в течение которых Skada должен ждать после начала боя, чтобы было достаточно событий для создания нового сегмента.\n\nРаботает, только если отключено |cffffbb00Агрессивное определение режима боя|r."
...
L["Persisten segments"] = "Постоянные сегменты"
