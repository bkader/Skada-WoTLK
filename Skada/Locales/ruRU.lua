...
L["Boss fights will be kept with this on and will not be affected by Skada reset."] = "При включении этой опции бои с боссами будут сохранены, и не будут затронуты сбросом Skada."
