...
L["Snap window"] = "스냅 창"
L["Allows the window to snap to other Skada windows."] = "창을 다른 Skada 창에 스냅 할 수 있습니다."
...
L["Left-Click to toggle windows."] = "창을 전환하려면 왼쪽 버튼을 클릭하십시오."
