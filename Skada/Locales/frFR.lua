...
L["Overhealing spell list"] = "Sorts d'excès de soin"
L["%s's overhealing spells"] = "Sorts d'excès de soin de %s"
L["%s's overhealed players"] = "Joueurs soignés en excès par %s"
L["Healing and overhealing"] = "Soins et excès de soin"
L["Healing and overhealing spells"] = "Sorts de soin et d'excès de soin"
L["Healed and overhealed players"] = "Cibles de soin et d'excès de soin"
L["%s's healing and overhealing spells"] = "Sorts de soin de %s"
...
L["Absorbs and healing spell list"] = "Sorts d'absorption et de soin"
...
L["CC Break spells"] = "Sorts de casse de contrôle"
L["CC Break spell targets"] = "Cibles du sort de casse de contrôle"
L["CC Break targets"] = "Cibles de casse de contrôle"
L["CC Break target spells"] = "Sorts de casse de contrôle sur la cible"
L["%s's CC Break <%s> spells"] = "Sorts de casse de contrôle de %s sur <%s>"
L["%s's CC Break <%s> targets"] = "Cibles de casse de contrôle de %s par <%s>"
L["%s's CC Break spells"] = "Sorts de casse de contrôle de %s"
L["%s's CC Break targets"] = "Cibles de casse de contrôle de %s"
-- options
L["CC"] = "CC"
...
L["%s interrupted!"] = "%s interrompu(e)!"
-- Power gained module --
L["Power"] = "Ressources"
...
L["%s's resurrect <%s> targets"] = "Cibles ressuscitées par <%2$s> de %1$s"
