...
L["CC Break spell targets"] = "Cibles du sort de brise de contrôle"
L["CC Break targets"] = "Cibles de brise de contrôle"
L["CC Break target spells"] = "Sorts de brise de contrôle sur la cible"
L["%s's CC Break <%s> spells"] = "Sorts de brise de contrôle de %s sur <%s>"
L["%s's CC Break <%s> targets"] = "Cibles de brise de contrôle de %s par <%s>"
...
L["%s interrupted with %s!"] = "%s interrompu avec %s!"
-- Power gained module --
L["Power"] = "Ressources"
