...
L["Skada is out of date. You can download the newest version from |cffffbb00https://github.com/bkader/Skada-Revisited|r"] = "Skada n'est pas à jour. Vous pouvez télécharger la nouvelle version sur |cffffbb00https://github.com/bkader/Skada-Revisited|r"
