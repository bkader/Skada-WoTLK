...
-- Debuffs uptime
-- :::::::::::::::::::::::::::::::::::
Skada:AddLoadableModule("Auras: Debuff uptime", nil, function(Skada, L)
  if Skada:IsDisabled("Auras: Debuff uptime") then return end
...
-- Sunder counter
-- :::::::::::::::::::::::::::::::::::
Skada:AddLoadableModule("Auras: Sunders Counter", nil, function(Skada, L)
  -- this module requires debuffs module
  if Skada:IsDisabled("Auras: Debuff uptime", "Auras: Sunders Counter") then return end
