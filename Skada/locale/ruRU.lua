...
L["Total healing"] = "ИиП: Всего исцеления"

L["Overhealing"] = "ИиП: Избыточное исцеление"
...
L["Healing and Overhealing"] = "ИиП: Исцеление и Избыточное исцеление"
...
L["Absorbs and healing"] = "ИиП: Исцеление и Поглощение"
...
L["Healing received"] = "ИиП: Получено исцеления"
...
L["CC Breakers"] = "Контроль: Прерванный"
...
L["Useful damage"] = "НУ: Полезный урон"

L["Damage done by spell"] = "НУ: От заклинаний"
...
L["Damage taken by spell"] = "ПУ: От заклинаний"
L["%s's targets"] = "%s: Цели"
L["DTPS"] = "ПУВС"

-- enemy damage done module
L["Enemy damage done"] = "ПУ: От противников"
...
L["Enemy damage taken"] = "НУ: Получено врагом"
...
L["Avoidance & Mitigation"] = "ПУ: Избегание и Уменьшение урона"
L["Damage breakdown"] = "Детали повреждений"
L["%s's damage breakdown"] = "%s: Детали повреждений"

-- friendly fire module
L["Friendly Fire"] = "НУ: По союзникам"
...
L["Improvement"] = "Другое: Улучшение"
...
L["Interrupts"] = "Другое: Прерывания"
...
L["Power"] = "Энергия"
L["Power gained"] = "ПЭ: Полученная энергия"
...
L["Parry-haste"] = "Другое: Пари-хаст"
L["Parry target list"] = "Парировавшие цели"
L["%s's parry targets"] = "%s: Парировавшие цели"

-- ==================== --
-- Potions module lines --
-- ==================== --

L["Potions"] = "Другое: Зелья"
...
L["Resurrects"] = "Другое: Воскрешения"
