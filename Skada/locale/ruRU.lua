...
L["Total healing"] = "ИиП: Исцеление [всего]"

L["Overhealing"] = "ИиП: Исцеление [избыточное]"
...
L["Healing received"] = "ИиП: Исцеление [полученное]"
...
L["Useful damage"] = "НУ: Урон [полезный]"
