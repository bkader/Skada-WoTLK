...
L["Fire"] = "Feu"
L["Frost"] = "Givre"
L["Frostfire"] = "Givre-feu"
L["Holy"] = "Sacré"
L["Nature"] = "Nature"
L["Naturefire"] = "Nature-feu"
L["Physical"] = "Physic"
L["Shadow"] = "Ombre"
...
-- data resets
L["Data resets"] = "Réinitialisation des données"
L["Reset on entering instance"] = "Réinitialiser en entrant en instance"
...
L["Reset on joining a group"] = "Réinitialiser en rejoignant un groupe"
...
L["Reset on leaving a group"] = "Réinitialiser en quittant un groupe"
...
L["Translit"] = "Translit"
L["Make those russian letters that no one understand to be presented as western letters."] = "Faites en sorte que ces lettres russes soient présentées comme des lettres occidentales."
...
L["Delete theme"] = "Suppression le thème"
...
L["Resets all fight data except those marked as kept."] = "Réinitialise les données de tous les combats sauf ceux choisis à garder."
L["Segment"] = "Segment"
L["Jump to a specific segment."] = "Choisir un segment spécific"
L["Mode"] = "Mode"
L["Jump to a specific mode."] = "Choisir un mode spécific"
L["Report"] = "Rapport"
...
L["Overhealed player list"] = "Liste des joueurs soignés en excès"
L["Overhealing spell list"] = "Liste des sorts de soin en excés"
L["%s's overhealing spells"] = "Sorts de soin en excès de %s"
L["%s's overhealed players"] = "Joueurs soignés en excés par %s"

L["Healing and Overhealing"] = "Soins prodigués et Soins en excès"

L["Absorbs"] = "Absorptions"
L["Absorbed player list"] = "Absorptions: liste des joueurs"
L["Absorb spell list"] = "Absorptions: liste des sorts"
L["%s's absorbed players"] = "%s: liste des joueurs"
L["%s's absorb spells"] = "%s: sorts d'absorption"

L["Absorbs and healing"] = "Absorptions et soins"
L["Absorbs and healing spell list"] = "Absorptions et soins: sorts"
L["Absorbed and healed players"] = "Absorptions et soins: joueurs"
L["%s's absorb and healing spells"] = "Absorptions et soins de %s: sorts"
L["%s's absorbed and healed players"] = "Absorptions et soins de %s: joueurs"
...
L["%s's <%s> targets"] = "Cibles du debuff <%s> de %s"
...
-- CC Done:
L["CC Done"] = "Contrôles utilisés"
L["CC Done spells"] = "Sorts de contrôle"
L["CC Done spell targets"] = "Cibles du sort de contrôle"
L["CC Done targets"] = "Cibles de contrôle"
L["CC Done target spells"] = "Sorts de la cible de contrôle"
L["%s's CC Done <%s> targets"] = "Cibles de <%s> de %s"
L["%s's CC Done <%s> spells"] = "Sorts de contrôle sur <%s> par %s"
L["%s's CC Done spells"] = "Sorts de contourner"
L["%s's CC Done targets"] = "Cibles de contrôle"

-- CC Taken
L["CC Taken"] = "Contrôles subis"
L["CC Taken spells"] = "Sorts du contrôle subis"
L["CC Taken spell sources"] = "Sources du sort de contrôle"
L["CC Taken sources"] = "Sources du contrôle"
L["CC Taken source spells"] = "Sorts de la source du contrôle"
L["%s's CC Taken <%s> sources"] = "Sources de <%s> subis par %s"
L["%s's CC Taken <%s> spells"] = "Sorts de contrôle de <%s> sur %s"
L["%s's CC Taken spells"] = "Sorts du contrôle subis"
L["%s's CC Taken sources"] = "Sources du contrôle subis"
...
L["%s's <%s> damage"] = "Dégâts de <%s> de %s"
...
L["%s's damage sources"] = "Sources de dégât de %s"
...
L["%s's gained %s"] = "%s acquise par %s"
