...
设置选项]=]
L["How many seconds the addon waits after \"Skada: *\" lines before it assumes spam burst is over. 1 seems to work in most cases"] = "多少秒后显示\"Skada: *\"的消息假定垃圾消息发送完毕。默认1秒"
